...
php -d extension=php_pdo_sqlite pause-cafe-app/tests/test-app.php        # 245
```

Plus 98 assertions over real HTTP for the app — see
[its tests README](pause-cafe-app/tests/README.md).

528 assertions in total. **Scope of that number matters:** the rules engines are
