...
php -d extension=php_pdo_sqlite pause-cafe-app/tests/test-app.php        # 332
```

Plus 136 assertions over real HTTP for the app — see
[its tests README](pause-cafe-app/tests/README.md).

653 assertions in total. **Scope of that number matters:** the rules engines are
