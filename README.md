...
php -d extension=php_pdo_sqlite pause-cafe-app/tests/test-app.php        # 218
```

Plus 88 assertions over real HTTP for the app — see
[its tests README](pause-cafe-app/tests/README.md).

491 assertions in total. **Scope of that number matters:** the rules engines are
